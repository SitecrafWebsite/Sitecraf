      ...
      >
        ...
        <div className="footer-column footer-links" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <ul className="footer-list" style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
            ...
            <li><Link href="/privacy" className="footer-link hover:text-[#b5ff3e]" style={{ fontSize: '16px', color: '#8888a0', textDecoration: 'none', transition: 'color 0.2s ease', fontFamily: 'var(--font-body)' }}>Privacy Policy</Link></li>
            <li><Link href="/terms" className="footer-link hover:text-[#b5ff3e]" style={{ fontSize: '16px', color: '#8888a0', textDecoration: 'none', transition: 'color 0.2s ease', fontFamily: 'var(--font-body)' }}>Terms of Service</Link></li>
          </ul>
        </div>
