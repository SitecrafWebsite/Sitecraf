        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <a 
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#25D366]/[0.1] border border-[#25D366]/[0.2] text-[#25D366] rounded-full hover:bg-[#25D366]/[0.15] hover:border-[#25D366]/[0.3] transition-all duration-300 font-semibold group text-center"
            >
